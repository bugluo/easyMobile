    ...
    function Sidebar(method){
        ...
        _Sidebar.prototype.init = function(){
            ...
            function init() {
                ...
                var container = document.getElementById( 'Esidebar-container' ),
                            reset = document.getElementById( 'closeMenu' ),
                    buttons = Array.prototype.slice.call( document.querySelectorAll( '#Esidebar-trigger-effects > button' ) ),
                    // event type (if mobile use touch events)
                    eventtype = mobilecheck() ? 'touchstart' : 'click',
                    resetMenu = function() {
                        classie.remove( container, 'Esidebar-menu-open' );
                    },
                    bodyClickFn = function(evt) {

                        if( !hasParentClass( evt.target, 'Esidebar-menu' ) ) {
                            resetMenu();
                ...
                buttons.forEach( function( el, i ) {
                    ...
                    el.addEventListener( eventtype, function( ev ) {
                        ...
                        ev.stopPropagation();
                        ev.preventDefault();
                        container.className = 'Esidebar-container'; // clear
                        classie.add( container, effect );
                        setTimeout( function() {
                            classie.add( container, 'Esidebar-menu-open' );
                        }, 25 );
